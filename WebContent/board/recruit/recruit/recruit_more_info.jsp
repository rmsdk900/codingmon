...
<section class="hero-body is-primary is-fullheight" >
   <form action="${pageContext.request.contextPath}/board/rec/write_info" method="post">
      <input type="hidden" name="cbr_num" value="${vo.cbr_num}" />
      <h2>부가 정보 입력</h2>
      <table class="table is-fullheight ">
         <tr>
            <th>직업</th>
               <td>
                  <div>
            ...
            <tr>
               <td>
                  <div>
                     <h3>임금 구분</h3>
                     <label>
                        <input type="radio" name="crp_code" value="1" />
                        시급
                     </label>
                     <label>
                        <input type="radio" name="crp_code" value="2" />
                        일급
                     </label>
                     <label>
                        <input type="radio" name="crp_code" value="3" />
                        월급      
                     </label>
                     <label>
                        <input type="radio" name="crp_code" value="4" />
                        연봉
                     </label>
                  </div>
               </td>
